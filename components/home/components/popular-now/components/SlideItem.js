    ...
    <div className="py-5">
      <div className="w-[200px] relative cursor-pointer select-none">
        <Link href={`${route_type}/${id}`} passHref={true} prefetch>
          <a>
          <div className="w-[200px] rounded-xl min-h-[295px] mb-1 relative popular-now-shadow border-2 border-solid border-primary overflow-hidden">
              <Image
                layout="fill"
                quality="10"
                className="  "
            ...
            <div className="px-3 py-1">
              ...
              <p className="text-xs my-1 text-gray ">{moment(release_date).format("D MMM, YYYY") }</p>
