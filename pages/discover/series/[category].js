...
/* Components */
import SeriesCategory from "../../../components/series-category";
  ...
  return (
    <>
      <Head>
        ...
        <meta name="title" content={`Discover ${category} series | CINE`} />
        <meta
          name="description"
        ...
        <meta
          property="og:url"
          content={`https://cine.tenyain.com/discover/series/${category}`}
        />
        <meta
          property="og:title"
          content={`Discover ${category} series | CINE`}
        />
        <meta
